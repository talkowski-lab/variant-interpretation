...
task runIGV_whole_genome{
    ...
    Float input_size = size(select_all([crams_to_localize, crais_to_localize, varfiles, fasta, fasta_idx, fasta_dict, nested_repeats, simple_repeats, empty_track, ped_file, crams, crais]), "GB")
