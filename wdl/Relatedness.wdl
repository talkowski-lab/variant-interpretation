...
workflow relatedness {
    ...
    scatter (vcf in vcf_files) {
        ...
        Array[File] subset_files = subsetPositionsVCF.vcf_output
        Array[File] subset_files_index = subsetPositionsVCF.vcf_output_index
        }
        ...
        Array[File] subset_files = select_first([excludeSVregions.vcf_output, subsetSVs.vcf_output])
        Array[File] subset_files_index = select_first([excludeSVregions.vcf_output_index, subsetSVs.vcf_output_index])
        }
    }
