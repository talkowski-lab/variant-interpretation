version 1.0
# Original source code: github.com/gatk-workflows/seq-format-conversion:3.0.0
...
workflow UninterleaveFastqs {
  ...
  output {
      File fastq_1 = uninterleave_fqs.r1_fastq
      File fastq_2 = uninterleave_fqs.r2_fastq
  }
}
