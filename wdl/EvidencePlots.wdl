...
workflow IGV_evidence {
    ...
    output{
        Array[File] pe_files = select_all(select_first([reformatPE_parse.pe_reformat, reformatPE_localize.pe_reformat]))
        Array[File] sr_files = select_all(select_first([reformatSR_parse.sr_reformat, reformatSR_localize.sr_reformat]))
