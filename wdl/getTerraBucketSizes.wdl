...
task getSubmissionInfo {
    ...
    submission_files.loc[:,'submission_id'] = submission_files.uri.str.replace('/intermediates','').str.replace('/final-outputs','').str.split('/').str[2]
...
task getSubmissionsToDelete {
    ...
    large_files.loc[:,'submission_id'] = large_files.uri.str.replace('/intermediates','').str.replace('/final-outputs','').str.split('/').str[2]
