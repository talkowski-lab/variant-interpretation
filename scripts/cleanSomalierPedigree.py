...
ped[~(new_ped.sex_error | new_ped.maternal_error | new_ped.paternal_error)].reset_index(drop=True).sort_values('sample_id').to_csv(f"{cohort_prefix}_ped_corrected.ped", sep='\t', index=False)
