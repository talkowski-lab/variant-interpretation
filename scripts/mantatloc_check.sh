...
svtk resolve manta.vcf.gz $id.manta.complex.vcf --mei-bed $meibed --cytobands $cytobands --discfile $discfile -u $id.manta.unresolved.vcf


bgzip $id.manta.complex.vcf
bgzip $id.manta.unresolved.vcf
